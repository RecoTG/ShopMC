...
public final class CategorySettings {
    ...
    public synchronized String permission(String name) { Entry e = map.get(name); return e == null ? "" : e.permission; }
    ...
    public synchronized void setPermission(String name, String perm) { ensureCategory(name); map.get(name).permission = perm == null ? "" : perm; save(); }
    ...
    public synchronized void load() {
        ...
        for (String k : y.getConfigurationSection("categories").getKeys(false)) {
            ...
            e.permission = y.getString("categories."+k+".permission", "");
            map.put(k, e);
        }
    }
    ...
    public synchronized void save() {
        ...
        for (String k : map.keySet()) {
            ...
            if (map.get(k).permission != null && !map.get(k).permission.isEmpty()) {
                y.set("categories."+k+".permission", map.get(k).permission);
            }
        }
